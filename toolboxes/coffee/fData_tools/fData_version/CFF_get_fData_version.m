...
%   of the input fData structure or matfile object.
%
...
%   version field, OR a struct (or matfile object) with no version field,
%   the function will assume this is an old fData struct and returns the
%   corresponding old version, i.e. '0.0'. However, if the input or an
%   input element is not an existing mat file, struct, or matfile object,
%   then the function returns empty. 
%
