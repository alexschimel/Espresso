...
% in datagram is listed in numSamplesArray in the struct EMdgmSKMinfo_def.
% Time given in datagram header, is time of arrival of data on serial line
% or on network. Time inside #KMB sample is time from the sensors data. If
% input is other than KM binary sensor input format, the data are converted
