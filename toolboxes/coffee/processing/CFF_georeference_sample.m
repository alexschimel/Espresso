...
%   based on the sample number, sample number offset, inter-samples
...
%   * |interSamplesDistance|: Required. A 1P matrix (or 1 scalar for 1
%   ping) of the distance between two samples in each beam.
