function [fData,params] = CFF_filter_bottom_detect(fData,varargin)
%CFF_FILTER_BOTTOM_DETECT  Filter and interpolate the bottom detections
%
...
%
%   FDATA = CFF_FILTER_BOTTOM_DETECT(FDATA) filters the bottom detect in
%   FDATA using default processing parameters, and returns 
%   FDATA with additional fields from the processing.
%
%   CFF_FILTER_BOTTOM_DETECT(FDATA,PARAMS) uses processing parameters
...
%
%   CFF_FILTER_BOTTOM_DETECT(...,'comms',COMMS) specifies if and how this
...
%
%   [FDATA,PARAMS] = CFF_FILTER_BOTTOM_DETECT(...) also outputs the
