...
%CFF_LL2TM  One-line description
%
...
%   grid convergence (angle between true north and grid north), point scale
%   factor and UTM zone if not specified in input. Different ellipsoids or
...
%   * |gridConv|: Grid convergence in degrees. Grid convergence is the
%   angle at a point between true and grid North. It is positive when grid
%   north lies to the West of the true North.  
