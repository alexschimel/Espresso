...
display_tab_comp.d_line_max=yline(display_tab_comp.d_lim_ax,1,'color',l_col,'Tag','d_line_max','linewidth',1.5,'fontsize',8,'LabelHorizontalAlignment','right','LabelVerticalAlignment','top',...
    'ButtonDownFcn',{@grab_vert_lim_cback,main_figure,'sonar'});
display_tab_comp.d_line_min=yline(display_tab_comp.d_lim_ax,0,'color',l_col,'Tag','d_line_min','linewidth',1.5,'fontsize',8,'LabelHorizontalAlignment','left','LabelVerticalAlignment','bottom',...
    'ButtonDownFcn',{@grab_vert_lim_cback,main_figure,'sonar'});
display_tab_comp.d_line_mean=yline(display_tab_comp.d_lim_ax,0.5,'color',l_col,'Tag','d_line_mean','linewidth',1.5,'fontsize',8,'LabelHorizontalAlignment','center','LabelVerticalAlignment','middle',...
    'ButtonDownFcn',{@grab_vert_lim_cback,main_figure,'sonar'});
...
display_tab_comp.d_lim_bot_patch = patch( display_tab_comp.d_lim_bot_ax,...
    ...
    'visible','on',...
    'YData', [0 1 1 0],'FaceColor',p_col,'FaceAlpha',0.2);
display_tab_comp.d_line_bot_max=yline(display_tab_comp.d_lim_bot_ax,1,'color',l_col,'Tag','d_line_max','fontsize',8,'linewidth',1.5,'LabelHorizontalAlignment','right','LabelVerticalAlignment','top',...
    'ButtonDownFcn',{@grab_vert_lim_cback,main_figure,'bot'});
display_tab_comp.d_line_bot_min=yline(display_tab_comp.d_lim_bot_ax,0,'color',l_col,'Tag','d_line_min','fontsize',8,'linewidth',1.5,'LabelHorizontalAlignment','left','LabelVerticalAlignment','bottom',...
    'ButtonDownFcn',{@grab_vert_lim_cback,main_figure,'bot'});
display_tab_comp.d_line_bot_mean=yline(display_tab_comp.d_lim_bot_ax,0.5,'color',l_col,'Tag','d_line_mean','fontsize',8,'linewidth',1.5,'LabelHorizontalAlignment','center','LabelVerticalAlignment','middle',...
    'ButtonDownFcn',{@grab_vert_lim_cback,main_figure,'bot'});
